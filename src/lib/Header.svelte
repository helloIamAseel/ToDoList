...
<header class="flex justify-between">
    <div>
      <h1 class="text-4xl">{dayOrNight} الخير👋</h1>
       <h2 class="text-xl mt-3 pl-20 text-black/50">
...
<button class="variant-ghost-success text-black btn variant-filled w-48 h-fit py-2 justify-between" use:popup={popupCombobox}>
...
<!-- bg-success-300-->
<div class="card w-48 shadow-xl py-2 variant-ghost-success" data-popup="popupCombobox">
